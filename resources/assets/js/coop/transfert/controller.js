(function (){
    ...
    var coopTransfertModule = angular.module('coopTransfertModule',[]);

    coopTransfertModule.controller('CoopTransfertCtrl',['$scope','$http','$location','tokenService','$rootScope'
        ,function($scope, $http, $location, tokenService,$rootScope) {
            ...
            $scope.envoyer = function(){
                ...
                console.log(data);
                $http.post($rootScope.requestUrl+'/livre/export/confirm',data).
            ...
            function getLivre(){
                $http.get($rootScope.requestUrl+'/livre/export').
                then(function(response) {
